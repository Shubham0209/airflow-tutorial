...
- `docker-compose down` - Stop containers
 ...
 In order to run `airflow-tutorial\examples\gcloud-example\dags\bigquery_github\bigquery_github_trends.py`, you need to set up a few things first. Specifically:
- Create a Google service account (Cloud Console)
- Setup a Google Cloud Connection in Airflow
- Supply the config variables
To know more follow [these](https://github.com/Shubham0209/airflow-tutorial/blob/main/docs/bigquery_github_trends.md) instructions.
